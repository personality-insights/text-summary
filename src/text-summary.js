...
class TextSummaryImpl {

  constructor(options, I18nData, PersonalityProfile) {
  ...
  setLocale(locale) {
    if (this._locale !== locale) {
      ...
      const dictionary = i18n.data();
      const translatorFactory = i18n.translatorFactory();
  ...
  //getSummary(profile) {
  getSummary(profile) {
    const personalityProfile = new this.PersonalityProfile(profile);
